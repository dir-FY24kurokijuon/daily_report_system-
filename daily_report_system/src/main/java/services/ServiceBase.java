...
各Serviceクラスのスーパークラスとなるクラスです。SQL実行に共通で必要となる EntityManager インスタンスの作成やクローズ処理を実装します。

EmployeeServiceクラス
services.EmployeeService.java（/src/main/java/services/EmployeeService.java）
package services;
